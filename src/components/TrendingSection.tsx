...
const TrendingSection = () => {
  ...
  return (
    <section className={`py-12 px-4 ${theme === 'dark' ? 'bg-gray-800/30' : 'bg-secondary/30'}`}>
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {trendingSearches.map(item => (
            <Card key={item.id} className={`hover:shadow-lg transition-shadow ${theme === 'dark' ? 'bg-gray-800 border-gray-700' : ''}`}>
